...
def load_data(dataset, bfs_level=3, relabel=False):
    if dataset in ['train20','train2','train4','train6','train8','train40','train60','train80','comp3','new_g','new_t3','new_t4','new_t2','new_t5','new_t1','new_50','new_t_50','new_t','fb','new','Sparse-YAGO15k-75', 'FB15k-237', 'Sparse-FB15k-237', "YAGO15k","Comp7"]:
